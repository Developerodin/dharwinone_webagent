# Generation benchmark — `phase3b-noledger`

Cases: 7 · generated 2026-08-22T15:14:55.344Z

## Scorecard

| Metric | phase3b-noledger | Target |
|---|---|---|
| Cross-build component reuse | 67.1% | lower is better |
| Distinct home compositions | 7 / 7 | ≥ 5 / 7 |
| Selections influenced by ledger | 0 | informational |
| Catalog-driven selections | 100.0% | > 0% |
| Section type mismatches | 0 | 0 |
| Media contract breaches | 0 | 0 |
| Compatibility penalties applied | 44 | informational |
| Page structure correct | 7 / 7 | 7 / 7 |
| Multi-page sites | 1 | 1 |
| Distinct section orders | 3 / 7 | ≥ 6 / 7 |
