# Generation benchmark — `phase3`

Cases: 7 · generated 2026-08-22T15:14:55.681Z

## Scorecard

| Metric | phase3 | phase2 | Target |
|---|---|---|---|
| Cross-build component reuse | 68.6% | n/a | lower is better |
| Distinct home compositions | 7 / 7 | n/a / 7 | ≥ 5 / 7 |
| Selections influenced by ledger | 45 | n/a | informational |
| Catalog-driven selections | 100.0% | 47.1% | > 0% |
| Section type mismatches | 0 | 0 | 0 |
| Media contract breaches | 0 | 0 | 0 |
| Compatibility penalties applied | 44 | 15 | informational |
