# Generation benchmark — `phase11`

Cases: 7 · generated 2026-08-22T14:33:52.082Z

## Scorecard

| Metric | phase11 | phase1 | Target |
|---|---|---|---|
| Page structure correct | 7 / 7 | 0 / 7 | 7 / 7 |
| Multi-page sites | 1 | 0 | 1 |
| Distinct section orders | 3 / 7 | 4 / 7 | ≥ 6 / 7 |
| Distinct layout signatures | 7 / 7 | 7 / 7 | ≥ 5 / 7 |
| Distinct surface rhythms | 6 / 7 | 5 / 7 | ≥ 5 / 7 |
| Distinct spacing rhythms | 4 / 7 | 5 / 7 | ≥ 4 / 7 |
| Distinct families | 3 | 3 | ≥ 3 |
| Distinct accents | 6 / 7 | 6 / 7 | ≥ 6 / 7 |
| Distinct display fonts | 5 / 7 | 5 / 7 | ≥ 4 / 7 |
| Distinct hero images | 6 / 7 | 6 / 7 | ≥ 6 / 7 |
| Image reuse rate | 35.3% | 36.2% | < 10% |
| Mean pairwise text Jaccard | 0.317 | 0.352 | < 0.30 |
...
- **site** `single_page` · pages `home` OK
- **order** `header>hero>about>menu>stats>gallery>reservation>location_map>contact>footer`
- **components** `premium-header-02, premium-hero-03, premium-about-01, premium-menu-03, premium-stats-02, premium-gallery-01, premium-reservation-02, premium-location-03, premium-contact-01, premium-footer-02`
...
- **components** `premium-header-01, premium-hero-02, premium-about-03, premium-gallery-02, premium-menu-01, premium-reservation-01, premium-footer-03`
...
- **images** 8 (8 unique, 0 duplicated)
