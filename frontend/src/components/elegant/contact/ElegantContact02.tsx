  ...
  return (
    <section aria-label="Contact and reservations" className="relative overflow-hidden bg-[var(--eg-bg-alt)]">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-14 @min-[640px]:px-6 @min-[640px]:py-18 @min-[768px]:px-10 @min-[768px]:py-24">
        <div className="grid gap-8 @min-[1024px]:grid-cols-[0.9fr_1.1fr] @min-[1024px]:items-start">
          <div>
          ...
          <div className={`${eg.panel} px-6 py-8 @min-[640px]:p-8 @min-[768px]:p-10`}>
            <h3 className={`text-[1.75rem] leading-tight ${eg.heading}`}>
            ...
            <form className="mt-8 space-y-5" noValidate onSubmit={form.handleSubmit}>
              <div className="grid gap-5 @min-[640px]:grid-cols-2">
                <div>
                  <label htmlFor={`${formId}-name`} className="text-[10px] font-medium uppercase tracking-[0.22em] text-[var(--eg-gold)] @min-[640px]:text-xs">
                    Name
                  </label>
                  <input
                    id={`${formId}-name`}
                ...
                <div>
                  <label htmlFor={`${formId}-email`} className="text-[10px] font-medium uppercase tracking-[0.22em] text-[var(--eg-gold)] @min-[640px]:text-xs">
                    Email
                  </label>
                  <input
                    id={`${formId}-email`}
                ...
                <div>
                  <label htmlFor={`${formId}-phone`} className="text-[10px] font-medium uppercase tracking-[0.22em] text-[var(--eg-gold)] @min-[640px]:text-xs">
                    Phone
                  </label>
                  <input
                    id={`${formId}-phone`}
                ...
                <div>
                  <label htmlFor={`${formId}-partySize`} className="text-[10px] font-medium uppercase tracking-[0.22em] text-[var(--eg-gold)] @min-[640px]:text-xs">
                    Party Size
                  </label>
                  <input
                    id={`${formId}-partySize`}
              ...
              <div className="grid gap-5 @min-[640px]:grid-cols-[0.9fr_1.1fr]">
                <div>
                  <label htmlFor={`${formId}-date`} className="text-[10px] font-medium uppercase tracking-[0.22em] text-[var(--eg-gold)] @min-[640px]:text-xs">
                    Preferred Date
                  </label>
                  <input
                    id={`${formId}-date`}
                ...
                <div>
                  <label htmlFor={`${formId}-message`} className="text-[10px] font-medium uppercase tracking-[0.22em] text-[var(--eg-gold)] @min-[640px]:text-xs">
                    Occasion / Notes
                  </label>
                  <textarea
                    id={`${formId}-message`}
              ...
              <div className="flex flex-col gap-3 @min-[640px]:flex-row @min-[640px]:items-center @min-[640px]:justify-between">
                <p className={`text-sm ${eg.body}`}>The team confirms each table personally.</p>
