...
/** Gold outline CTA for centered elegant header (display gated separately). */
...
/**
 * Elegant sticky header — single row: brand+tagline left | inline gold nav center | CTA right.
        ...
        >
          <div className="flex items-center gap-2.5 @min-[640px]/page:gap-3">
            <span
              ...
              aria-hidden="true"
            />
            <span className="truncate font-[family-name:var(--eg-font-display)] text-lg tracking-[0.1em] text-[var(--eg-cream)] @min-[640px]/page:text-xl @min-[768px]/page:text-2xl">
              {brandName}
            </span>
          </div>
          {tagline ? (
            <p className="mt-0.5 hidden max-w-xs truncate font-[family-name:var(--eg-font-body)] text-[11px] text-[var(--eg-muted)] @min-[1024px]/page:block">
              {tagline}
            </p>
          ) : null}
        </button>
