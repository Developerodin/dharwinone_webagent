...
/**
 * Premium sticky header — single row: brand left | inline nav center | CTA right.
    ...
    >
      <div className="mx-auto flex w-full min-w-0 max-w-7xl items-center gap-3 px-4 py-2.5 @min-[640px]/page:px-6 @min-[640px]/page:py-3 @min-[768px]/page:gap-6 @min-[768px]/page:px-10">
        ...
        >
          ...
          {tagline ? (
            <p className="mt-0.5 hidden max-w-xs truncate text-[11px] text-[var(--theme-muted)] @min-[1280px]/page:block">
              {tagline}
            </p>
          ) : null}
        </button>
