        ...
        <ul className="mt-10 space-y-0 @min-[640px]:mt-14" role="list">
          {items.length === 0 ? (
            ...
            items.map((item) => (
              <li
                key={item.name}
                className="flex flex-col gap-2 border-t border-[var(--line)] py-5 first:border-t-0 @min-[640px]:flex-row @min-[640px]:items-start @min-[640px]:justify-between @min-[640px]:gap-4 @min-[640px]:py-7"
              >
