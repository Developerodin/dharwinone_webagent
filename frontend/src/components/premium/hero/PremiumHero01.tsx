...
export function PremiumHero01({ content, assets }: SectionComponentProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex min-h-[60svh] max-w-[var(--sec-measure,72rem)] flex-col justify-end px-4 py-16 @min-[640px]:min-h-[70svh] @min-[640px]:px-6 @min-[640px]:py-20 @min-[768px]:min-h-[85vh] @min-[768px]:px-10 @min-[768px]:py-24">
